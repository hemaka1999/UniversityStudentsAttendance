...
List<OnboardingModel> tabs = [
  ...
  OnboardingModel(
    'assets/lottie/startup1.json',
    'Attendance Mark Simply',
    'You can easily mark your attendance \nby using this app.',
  ),
  OnboardingModel(
    'assets/lottie/startup2.json',
    'Sign Up',
    'First you need to sign up \nthe system, \nAnd Sign it.',
  ),
  OnboardingModel(
    'assets/lottie/startup3.json',
    'Scan QR',
    'You can mark your attendance, \nby scanning lecture\'s QR \nwhen your entrance',
  ),
];
